# Operator Quickstart — Community Private Security Operations

Shortest path from clone to a verified local dry-run for **ISIC 8010** (`cloud-itonami-isic-8010`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8010.git
cd cloud-itonami-isic-8010
```
...
- Blueprint governor key: `private-security-governor`
- Likely source path: `src/**/private-security-governor.cljc`
